...
export function ResultsRoute() {
  ...
  return (
    <>
      ...
      <ResultsShell>
        <ResultsHeader />
        <section className="mt-6 flex flex-1 rounded-[28px] border border-white/10 bg-[radial-gradient(circle_at_88%_10%,rgba(124,255,124,0.12),transparent_32%),linear-gradient(180deg,#0A0E14_0%,#11161E_100%)] shadow-[0_30px_90px_rgba(0,0,0,0.4)] lg:overflow-hidden">
          <ResultsView
